...
{% hint style="info" %}
PASS로 인증하기를 선택했을 때 QR 코드로 인증하기 버튼을 터치하면 스마트폰의 카메라를 사용해 QR코드 인증을 할 수 있습니다. [PASS 이용가이드 보기](https://www.passauth.co.kr/guide)
{% endhint %}

![](<../../../.gitbook/assets/image (3).png>)

{% embed url="https://www.passauth.co.kr/guide" %}
